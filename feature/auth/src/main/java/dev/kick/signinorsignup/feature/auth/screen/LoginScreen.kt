...
fun LoginScreen(
    ...
    AuthBaseScaffold(
        ...
        description = stringResource(id = R.string.auth_login_description),
        modifier = modifier,
    ) {
        AuthTextField(
            value = uiState.email,
            ...
            helperTextResId = R.string.auth_helper_email_confirmed,
            enabled = false,
        )
        ...
        AuthTextField(
            ...
            placeholderResId = R.string.auth_placeholder_password,
