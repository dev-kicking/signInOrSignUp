...
fun SignupEmailScreen(
    ...
    AuthBaseScaffold(
        title = stringResource(id = R.string.auth_signup_email_title),
        description = stringResource(id = R.string.auth_signup_email_description),
        modifier = modifier,
    ) {
        AuthTextField(
            value = uiState.email,
            ...
            helperTextResId = R.string.auth_helper_signup_required,
        ...
        AuthPrimaryButton(
            ...
            enabled = uiState.isSignupEmailSubmitEnabled,
        )
    }
}
